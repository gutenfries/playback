import 'package:playback/widgets/card_highlight.dart';
import 'package:playback/widgets/page.dart';
    ...
    return ScaffoldPage.scrollable(
      ...
      children: [
        const Text(
          ...
          'as a relative quantity, not a numeric value. For playback, users think '
...
''',
    ...
    *   Use a natural orientation. For playback, if the slider represents a real-world value that is normally shown vertically (such as temperature), use a vertical orientation.
